...
// introdução,e como o usuario deve digita as infomarçoes pra nao da errdo
    ...
    printf("As informações deve ser escrita tudo junto,sem spaço.\n");
    printf("\n");
...
//imprimindo as informações da carta 1 
    ...
    printf("Area da cidade: %.2f\n", kilometros1);//medimento da Area da card 1

    printf("O numero do PIB: %.2f\n", PIB1);//numero do PIB da card 1

    printf("Quantidade de pontos turisticos: %d\n", pontosTuristicos1);//numero de pontos turisticos card 2
    printf("\n");
 ...
 //imprimindo as informações da carta 2
    ...
    printf("Numero do codego: %s\n", code2);//numero do code da carta card 2
