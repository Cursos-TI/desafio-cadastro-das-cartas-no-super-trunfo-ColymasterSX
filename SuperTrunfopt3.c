...
//calculo das 2 variaves densidade populacional e PIB per capita
 ...
 //imprimindo as informações da carta 1 
  ...
  //imprimindo as informações da carta 2
    ...
    //codego da comparação dos dados das cartas recebida do usuario
    ...
    if (kilometros1 > kilometros2)//area
    {
       printf("1\n");
    } else{
        printf("0\n");
    ...
    if (pontosTuristicos1 > pontosTuristicos2)//pontos turisticos
    {
       printf("1\n");
    } else{
        printf("0\n");
    ...
    if (PIBperCapita1 > PIBperCapita2)//PIB per capita
    {
       printf("1\n");
    } else{
        printf("0\n");
    ...
    if (DensidadePopulacional1 < DensidadePopulacional2)// desindade populacional
    {
       printf("1\n");
    } else{
        printf("0\n");
    ...
    if (SuperPoder1 > SuperPoder2)//super poder(soma de todas as variaves)
    {
       printf("1\n");
    } else{
        printf("0\n");
